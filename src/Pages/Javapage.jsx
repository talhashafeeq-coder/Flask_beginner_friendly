...
const Javapage = () => {
    ...
    const pythonTutorials = tutorials.filter(tutorial =>
        tutorial.topic_name && tutorial.topic_name.trim().toLowerCase().startsWith("java")
    );
    ...
    return (
        <div style={{ display: "flex", height: "100vh" }}>
           ...
           <div className="sidebar">
                        ...
                        {pythonTutorials.map((tutorial) => {
                            ...
                            return (
                                <li key={tutorial.id} style={{ padding: "5px 0" }}>
                                    {/* ✅ Only Show Dropdown Icon If There Are Subtopics */}
                                    ...
                                    >
                                        ...
                                        {topicSubtopics.length > 0 && (
                                            <span> {expandedTopics[tutorial.id] ? "▼" : "▶"}</span>
                                        )}
                                    </button>

                                    {/* ✅ Show Subtopics Only If Available */}
            ...
            <h1 className="text-center mb-2 p-3 animate__animated animate__lightSpeedInLeft  ">JAVA Tutorials</h1>
